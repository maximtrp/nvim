...
function M.setup()
  ...
  set_highlight("NeoTreeGitUntracked", { link = "NeoTreeGitAdded" })
  set_highlight("WinSeparator", { fg = colors.background })
  set_highlight("CursorLine", { bg = colors.bright_grey })
  ...
  set_highlight("GitSignsStagedChange", { fg = colors.orange })
  set_highlight("GitSignsStagedAdd", { fg = colors.green })
  set_highlight("GitSignsStagedDelete", { fg = colors.red })
  ...
  set_highlight("@comment.todo", { link = "Comment" })
  set_highlight("@comment.note", { link = "Comment" })
